...
contract('configurableLP', async accounts => {
  ...
  it('Only the owner can whitelist an LP', async () => {
    await truffleAssert.reverts(crpPool.whitelistLiquidityProvider(admin2, { from: admin3 }), 'ERR_NOT_CONTROLLER');
  });
  ...
  describe('Whitelist admin and admin3', async () => {
    ...
    it('admin2 cannot join pool', async () => {
      ...
      await truffleAssert.reverts(crpPool.joinPool(toWei('1'), maxAmountsIn, { from: admin2 }), 'ERR_NOT_ON_WHITELIST');
