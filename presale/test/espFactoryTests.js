...
contract('ESPFactory', async accounts => {
  ...
  before(async () => {
    ...
    ESPPOOL = await espFactory.newEsp.call(bFactory.address, poolParams, permissions);

    await espFactory.newEsp(bFactory.address, poolParams, permissions);
  ...
  it('should be able to create with mismatched start Weights', async () => {
    ...
    await truffleAssert.reverts(
      espFactory.newEsp(bFactory.address, poolParams, permissions),
  ...
  it('should not be able to create with zero fee', async () => {
    ...
    await truffleAssert.reverts(espFactory.newEsp(bFactory.address, poolParams, permissions), 'ERR_INVALID_SWAP_FEE');
  });
